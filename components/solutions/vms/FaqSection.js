            ...
            {faqs.map((faq, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`border rounded-2xl overflow-hidden transition-colors ${isOpen ? 'bg-white border-purple-300 shadow-md' : 'bg-slate-100 border-slate-200 hover:border-slate-300'}`}
                >
                  <button
                  ...
                  >
                    ...
                    <span className={`text-xl transition-transform duration-300 ${isOpen ? 'rotate-180 text-purple-600' : 'text-slate-400'}`}>
