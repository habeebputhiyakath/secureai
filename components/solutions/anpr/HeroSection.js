  ...
  return (
    <>
      <style>{`
        ...
        .sph-d4{transition-delay:.4s} .sph-d5{transition-delay:.5s}
        .sph-dotgrid::before {
          content: ''; position: absolute; inset: 0; pointer-events: none;
          background-image: radial-gradient(circle, #cbd5e1 1px, transparent 1px);
          background-size: 28px 28px; opacity: 0.4;
        }
        @keyframes sphPulse { 0%,100%{opacity:1} 50%{opacity:.25} }
        ...
        .sph-anchor:hover { background:#eaf1ff;border-color:#0161FE;
        ...
        .sph-btn-p:hover { background:#0052d6;transform:translateY(-2px);
        ...
        .sph-btn-s:hover { border-color:#0161FE;color:#0161FE;transform:translateY(-2px); }
        ...
        .sph-frame img { display:block; width:100%; height:100%; object-fit:cover; }
        .sph-live-badge {
      ...
      <section ref={ref} className="sph-dotgrid relative overflow-hidden flex items-center pt-[104px] pb-20 lg:pb-28 bg-white border-b border-slate-100">
        ...
        <div className="relative w-full max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-16 items-center">
            ...
            <div>
              <div className="sph-rev sph-d0 mb-7">
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full"
                  ...
                  <span className="sph-pulse w-1.5 h-1.5 rounded-full" style={{ background:'#0161FE' }} />
                  Enterprise ANPR Solutions
                </span>
              </div>

              <h1 className="sph-rev sph-d1 font-extrabold tracking-tight text-slate-900 mb-4"
                style={{ fontSize:'clamp(2.4rem,4.2vw,3.5rem)',lineHeight:1.1 }}>
                Enterprise Automatic Number Plate Recognition <span style={{ color:'#0161FE' }}>(ANPR) Solutions</span>
              </h1>
              ...
              <p className="sph-rev sph-d3 text-slate-500 text-base sm:text-lg leading-relaxed mb-10 max-w-xl">
                SecureAAi Si Pro ANPR™ delivers accurate vehicle identification, real-time monitoring, and actionable traffic intelligence — for smart cities, parking, gated communities, logistics, highways, and law enforcement.
              </p>

              <div className="sph-rev sph-d4 flex flex-wrap gap-4 mb-12">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="sph-frame aspect-[4/3]">
                <img src="/products/sipro/sipro.png" alt="Si.PRO ANPR gantry recognizing live traffic with AI classification overlays" />
                <span className="sph-live-badge">
                  <span className="sph-pulse w-1.5 h-1.5 rounded-full bg-emerald-400" />
                  Live Recognition
                </span>
              </div>

              <div className="sph-float-card hidden sm:block" style={{ bottom: -22, left: -22 }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-slate-900 leading-none">98.7% Accuracy</div>
                    <div className="text-[0.7rem] text-slate-400 mt-1">Real-time, all conditions</div>
                  </div>
                </div>
              </div>
            </motion.div>
