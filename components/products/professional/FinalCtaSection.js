    ...
    <>
      <style>{`
        ...
        .pcta-scan {
          ...
          background:linear-gradient(90deg,transparent,rgba(253,230,138,0.45) 50%,transparent);
          animation:pctaScan 3.4s linear infinite; pointer-events:none;
        }
        .pcta-btn-primary {
          display:inline-flex; align-items:center; gap:9px;
          font-size:0.72rem; font-weight:700; letter-spacing:0.12em;
          text-transform:uppercase; color:#78350f; background:#fff;
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #451a03 0%, #78350f 55%, #92400e 100%)' }}
      >
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-10 text-center">
          ...
          >
            ...
            <h2 className="pcta-rev pcta-d1 text-4xl sm:text-5xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.06] mb-6">
              Expert Guidance. Reliable Support. <br/>
              <span className="text-amber-300">Long-Term Value.</span>
            </h2>

            <p className="pcta-rev pcta-d2 text-orange-100 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-12">
              Through SiCare™, Annual Maintenance Contracts, and Professional Services, SecureAAi Systems helps organizations maximize the value of their security investments while ensuring reliability, scalability, and future readiness. Building intelligent security ecosystems through innovation, expertise, and world-class support.
            </p>

            <div className="pcta-rev pcta-d3 flex flex-wrap items-center justify-center gap-4">
              ...
              <a href="#" className="pcta-btn-secondary">DOWNLOAD BROCHURE</a>
            </div>
          </motion.div>
        </div>
      </section>
